...
if __name__ == "__main__":
    ...
    d_train = SegmentationDataset(HPP_DEFAULT, train_data_path, train_masks_path, train=True, pad_mask=True)
    d_val = SegmentationDataset(HPP_DEFAULT, val_data_path, val_masks_path, train=False, pad_mask=True)
